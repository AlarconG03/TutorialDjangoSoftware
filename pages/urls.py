...
from .views import HomePageView, AboutPageView, ContactPageView, ImageViewNoDI, ProductIndexView
from .views import ProductShowView, ProductCreateView, CartView, CartRemoveAllView
